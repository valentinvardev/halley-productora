...
/** Login de familias: sólo el email, y le llega el link para entrar. */
      ...
      {entrar.isSuccess ? (
        <>
          ...
          <p className="mt-4 text-[13.5px] leading-relaxed text-gray-70">
            Si <strong>{entrar.data.email}</strong> tiene una cuenta, le acabamos
            de mandar un link para entrar. Vence en 30 minutos.
          </p>
        ...
        <>
          ...
          <p className="mt-3 mb-6 text-[13.5px] leading-relaxed text-gray-70">
            Poné tu email y te mandamos un link para entrar. No hay contraseña
            que recordar.
          </p>
