            ...
            {filas.map((fila) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="w-12 shrink-0 font-rotulo text-[12px] tracking-[0.06em] text-gray-45">
                  ...
                  {pagada ? (
                    <span className="shrink-0 font-rotulo text-[11px] uppercase tracking-[0.06em] text-gray-45">
                      Listo
                    </span>
                  ) : (
                    <Link
                      href={`/mi/pagar/${alumnoId}?hasta=${fila.id}`}
                      className="shrink-0 border border-ink px-3 py-2 text-right font-rotulo text-[11px] uppercase tracking-[0.05em] hover:bg-ink hover:text-paper"
                    >
